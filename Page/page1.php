  ...
  if(isset( $_GET['id']) AND $_GET['id'] > 0)
   {
    ...
    $userdon=$ruser -> fetch();
         ...
         if(isset( $_POST['envoyesex'])){
                                                        ...
                                                        header('Location: page2am.php?id='.$_SESSION['id']);
                                    }
...
?>
    ...
    <div class="col-xs-2 yx"><a id="abc" href="#">2</a></div>
 ...
 <div  style="height:260px;text-align:center;"> 
   <h2 style="margin-top:20px;margin-bottom:40px;color:#E25326; ">BIENVENUE DANS LE DOMAINE NFZ</h2>
   <h4 style="opacity:0.7;margin-bottom:20px;">Afin de mieux vous etes a atteindre vos objectifs et rendre </h4>
   <h4  style="opacity:0.7;margin-bottom:20px;">  plus pratique votre regime et votreentrainement . </h4>
   <h4  style="opacity:0.7;margin-bottom:20px;">nous avons de vous certaines informations</h4>

 </div>
    <div style="border-top:0.0625rem solid rgba(39, 33, 33, 0.1);box-shadow:0px 0px 30px 0px lightgrey inset;">
    <button type="button" class="btn btn-default elone1"><a href="../profilameliore.php?id=<?php echo urlencode($_SESSION['id']);?>">Non,Merci</a></button>
<input style="float:right;" type="submit" name="envoyesex" class="btn btn-default elone2" value="Oui,avec plaisir" />
  </div>
 </div>
</form>
