...
<body>
 ...
 <?php
   include ('navbar.php');?>
    ...
    <div class="col-xs-1 yx"><a id="abc"  href="#">3</a></div>
...
<h2 style="margin-top:20px;margin-bottom:10px;color:#E25326; ">SEXE</h2>
<form>
  <label>
  <input type="radio" name="fb" value="small" />
  <img href="" style="padding:20px;margin-bottom:20px;" src="woman.jpg" height="220px" width="220px" >
</label>
<label>
  <input type="radio" name="fb" value="small" />
  <img href="" style="padding:20px;margin-bottom:20px;" src="men.jpg" height="220px" width="220px" >
</label>
  </form> 
