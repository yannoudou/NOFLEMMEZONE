...
<body>
 ...
 <?php
   include ('navbar.php');?>
    ...
    <div class="col-xs-1 yx"><a id="abc1" href="#">4</a></div>
...
<div class="form-group">
      ...
      <input type="number" class="form-control1" id="donne" placeholder="chest" name="chest">
    </div>
     
  
    <div class="form-group">
      <label for="naissance">age:</label>
      <input type="number" class="form-control1" id="donne" placeholder="age"name="naissance">
    </div>
     <div class="form-group">
      <label for="poids">poids:</label>
      <input type="number" class="form-control1" id="donne" placeholder="poids" name="poids">
    </div>
