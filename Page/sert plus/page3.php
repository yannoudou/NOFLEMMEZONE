...
<body>
 ...
 <?php
   include ('navbar.php');?>
    ...
    <div class="col-xs-1 yx "><a id="abc1"  href="#">1</a></div>
    <div class="col-xs-1 yx"><a id="abc1" href="#">2</a></div>
    <div class="col-xs-1 yx"><a id="abc1"  href="#">3</a></div>
    <div class="col-xs-1 yx"><a id="abc" href="#">4</a></div>
    <div class="col-xs-1 yx"><a id="abc"  href="#">5</a></div>
    <div class="col-xs-1 yx"><a id="abc"  href="#">6</a></div>
    <div class="col-xs-1 yx"><a id="abc"  href="#">7</a></div>
    <div class="col-xs-1 yx"><a id="abc" href="#">8</a></div>
    <div class="col-xs-1 yx"><a id="abc" href="#">9</a></div>
    <div class="col-xs-1 yx"><a  id="abc"href="#">10</a></div>
    <div class="col-xs-1 yx"><a  id="abc" href="#">11</a></div>
    <div class="col-xs-1 yx"><a id="abc" href="#">12</a></div>
...
<h2 style="margin-top:20px;margin-bottom:10px;color:#E25326; ">METHODES POUR CALCUL DE BODYFAT</h2>
<a href=""><img href="" style="padding:20px;margin-bottom:20px;"src="men.jpg" height="150px" width="150px">
</a>
<a href=""><img href="" style="padding:20px;margin-bottom:20px;" src="woman.jpg" height="150px" width="150px"></a>
<a href=""><img href="" style="padding:20px;margin-bottom:20px;" src="woman.jpg" height="150px" width="150px"></a>
    ...
    <button type="submit" class="btn btn-default elone1">Retour</button>
<button style="float:right;" type="submit" class="btn btn-default elone2">Suivant</button>
  </div>
 </div>
