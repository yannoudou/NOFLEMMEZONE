...
<div class="form-group">
      ...
      <input type="number" class="form-control" id="donne" placeholder="chest" name="chest">
    </div>
     
  
    <div class="form-group">
      <label for="naissance">age:</label>
      <input type="number" class="form-control" id="donne" placeholder="age"name="naissance">
    </div>
    <div class="form-group">
      <label for="poids">poids:</label>
      <input type="number" class="form-control" id="donne" placeholder="poids" name="poids">
    </div>
     
  
    <div class="form-group">
      <label for="reins">tour des reins:</label>
      <input type="number" class="form-control" id="donne" placeholder="Tour de Reins"name="reins">
    </div>
